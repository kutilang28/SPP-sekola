          ...
          <form action="{{url('transaksi', $transaksi->id_transaksi)}}" method="post">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input for="tgl_bayar" name="tgl_bayar" type="date" class="form-control" id="tgl_bayar" placeholder="">
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label for="bulan_dibayar">Bulan Dibayar</label>
                <input for="bulan_dibayar" name="bulan_dibayar" type="text" class="form-control" id="bulan_dibayar" placeholder="">
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label for="tahun_bayar">Tahun Dibayar</label>
                <input for="tahun_bayar" name="tahun_dibayar" type="text" class="form-control" id="tahun_dibayar" placeholder="">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input for="jumlah_bayar" name="jumlah_bayar" type="number" class="form-control" id="jumlah_bayar" placeholder="">
              </div>
            </div>
            <!-- /.card-body -->

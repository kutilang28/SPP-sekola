          ...
          <form action="{{url('siswa')}}" method="post">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input for="nisn" name="nisn" type="number" class="form-control" id="nisn" placeholder="" required>
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label for="nis">nis</label>
                <input for="nis" name="nis" type="number" class="form-control" id="nis" placeholder="" required>
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label for="nama">Nama</label>
                <input for="nama" name="nama" type="text" class="form-control" id="nama" placeholder="" required>
              </div>
            </div>
            <div class="form-group">
              <select name="id_kelas" id="id_kelas" class="form-control select2">
                ...
                @foreach ($idkel as $item)
                    <option value="{{ $item->id_kelas }}" @required(true)>{{$item->nama_kelas}}</option>
                @endforeach
              </select>
            </div>
            <div class="card-body">
